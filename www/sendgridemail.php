...
$email->setSubject($_SESSION['NAME'] . " - Hours From: " . $D1_DATE . " - " . $D5_DATE);
...
" . $D2_DATE . " | " . $D2_Start . " - " . $D2_End . " | " . $_SESSION['D2_TOTAL'] . "<br>
" . $D3_DATE . " | " . $D3_Start . " - " . $D3_End . " | " . $_SESSION['D3_TOTAL'] . "<br>
" . $D4_DATE . " | " . $D4_Start . " - " . $D4_End . " | " . $_SESSION['D4_TOTAL'] . "<br>
" . $D5_DATE . " | " . $D5_Start . " - " . $D5_End . " | " . $_SESSION['D5_TOTAL'] . "</h4>
<hr>
<h4>WEEK TOTAL:" . $_SESSION['TOTAL_HOURS'] . " </h4>
